...
`Variant` is a task runner / CLI generator. It transforms your workflows written in YAML into a modern CLI application. All you need to write some YAML and add a shebang to call `variant`.
